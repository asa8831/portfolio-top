...
<body>
  <main>
    <section class="section-wrapper">
      ...
      <p>今回はPHPで最低限の機能のみ実装しましたが、jsで動きをつけるなどすればより可愛らしさが増し、実際サービスとして運用した際も利用してもらえる率が高まるのではないかと考えております。<br>サービスとして運用した時に、どうすればより効果的に集客できるかを常に考えて行かねばならないと反省しております。
      </p>
      <!-- 説明部分 -->
