...
<body>
  <main>
    <section class="section-wrapper">
      ...
      <p>小さな子供と遊ぶことを目的としたものなので、画面や機能はなるべくシンプルにわかりやすくを心がけ、ゲームの内容や使用する画像も可愛らしくほのぼのとしたものを選びました。</p>
      ...
      <p>オブジェクト指向型で記載をする場合、手続き型と違い処理ごとに記載をまとめてあるため、何の処理をどこで担当しているかをきちんと把握していないと、不具合の出ている箇所を発見するのに時間がかかる点に苦労しました。<br>実際このゲームを作成中、途中でどのコマンドをえらんでも「警戒心」が減らなくなるという不具合が起きましたが、原因の究明に時間がとてもかかってしまったのを覚えています。 <br>仕事として扱う以上経験が浅いという言い訳は勿論使うことはできないので、慢心することはなく、技術の習得に努めていかなければいけないことを再確認しました。
      </p>
      <h2 class="heading">今後の課題として取り組んでいきたいこと</h2>
      <p>今回はPHPで最低限の機能のみ実装しましたが、JavaScriptで動きをつけるなどすればより可愛らしさが増し、実際サービスとして運用した際も利用してもらえる率が高まるのではないかと考えております。<br>サービスとして運用した時に、どうすればより効果的に集客できるかを常に考えて行かねばならないと反省しております。
      </p>
      <!-- 説明部分 -->
