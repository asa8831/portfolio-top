...
<body>
  <main>
    <section class="section-wrapper">
      ...
      <p>コロナ禍で売り上げが落ち服飾関係の店の閉店が相次いでいるとのニュースを読み、売り上げを回復させるにはECサイトの存在が今までよりも重要になってくると考えました。特に家族で気軽に利用できるようなサイトであれば、幅広い年代からアクセスがあり、より売り上げ回復に効果的だと推測を立て、作成を行いました。</p>
