...
<body>
  <main>
    <section class="section-wrapper">
      ...
      <p>フェードインするスライダーをプラグインなしで作成しましたが、作成当初スライダーが下のコンテンツに重なって表示されてしまい、それの解決が今回一番苦労しました。<br>最初は焦って闇雲に調べるところから始めてしまいましたが、一旦仮説を立てて解決を図った結果、うまく表示させることができました。<br>焦ったときほど手当り次第に行動してしまいますが、落ち着いて何が原因かを探ることで解決の糸口が見えてきたので、まずは仮説を立てることを徹底していきたいと思います。</p>
